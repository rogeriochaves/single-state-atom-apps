...
todomvc.utils.guid = (function guid(){
return goog.ui.IdGenerator.getInstance().getNextUniqueId();
});
todomvc.utils.now = (function now(){
return (new Date());
});
todomvc.utils.pluralize = (function pluralize(n,word){
if((n === (1))){
return word;
} else {
...
var store = null;
var store__1 = (function (ns){
return store.cljs$core$IFn$_invoke$arity$2(ns,null);
});
var store__2 = (function (ns,edn){
if(!((edn == null))){
return localStorage.setItem(ns,[cljs.core.str(edn)].join(''));
} else {
var s = localStorage.getItem(ns);
if(!((s == null))){
...
;
todomvc.utils.hidden = (function hidden(is_hidden){
