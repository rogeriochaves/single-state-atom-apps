...
var i_39999 = (0);
while(true){
if((i_39999 < arr.length)){
(arr[i_39999] = null);

var G__40000 = (i_39999 + (1));
i_39999 = G__40000;
continue;
} else {
}
...
var i_40012 = (self__.level + (1));
while(true){
if((i_40012 <= (new_level + (1)))){
(update[i_40012] = self__.header);

var G__40013 = (i_40012 + (1));
i_40012 = G__40013;
continue;
} else {
}
...
var i_40014 = (0);
while(true){
if((i_40014 <= self__.level)){
var links_40015 = (update[i_40014]).forward;
if(((links_40015[i_40014]) === x__$1)){
(links_40015[i_40014] = (x__$1.forward[i_40014]));

var G__40016 = (i_40014 + (1));
i_40014 = G__40016;
continue;
} else {
var G__40017 = (i_40014 + (1));
i_40014 = G__40017;
continue;
}
} else {
...
if(!((nx == null))){
var G__40019 = nx;
var G__40020 = (level__$1 - (1));
x = G__40019;
level__$1 = G__40020;
continue;
} else {
var G__40021 = x;
var G__40022 = (level__$1 - (1));
x = G__40021;
level__$1 = G__40022;
continue;
}
...
var G__40024 = nx;
var G__40025 = (level__$1 - (1));
x = G__40024;
level__$1 = G__40025;
continue;
} else {
var G__40026 = x;
var G__40027 = (level__$1 - (1));
x = G__40026;
level__$1 = G__40027;
continue;
}
...
var or__3776__auto__ = (cljs.core.truth_((function (){var and__3764__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3776__auto__,timeout__$1,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);

return cljs.core.async.impl.protocols.close_BANG_(timeout_channel);
});})(timeout_channel,or__3776__auto__,timeout__$1,me))
,msecs);
