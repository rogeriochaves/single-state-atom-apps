...
return s.replace((new RegExp((function (){var G__41179 = match;
return goog.string.regExpEscape(G__41179);
})(),"g")),replacement);
} else {
...
while(true){
if(coll__$1){
var G__41180 = sb.append([cljs.core.str(cljs.core.first(coll__$1))].join(''));
var G__41181 = cljs.core.next(coll__$1);
sb = G__41180;
coll__$1 = G__41181;
continue;
} else {
...
var G__41184 = cljs.core.pop(v__$1);
v__$1 = G__41184;
continue;
} else {
return v__$1;
...
var pred__41192 = cljs.core._EQ_;
var expr__41193 = limit;
if(cljs.core.truth_((function (){var G__41195 = (1);
...
if(cljs.core.truth_((function (){var G__41197 = (2);
...
var G__41202 = s__$1.substring((index + cljs.core.count(m)));
var G__41203 = (limit__$1 - (1));
var G__41204 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__41202;
limit__$1 = G__41203;
parts = G__41204;
continue;
...
var G__41206 = s;
return goog.string.trim(G__41206);
});
/**
...
var G__41208 = s;
return goog.string.trimLeft(G__41208);
});
/**
...
var G__41210 = s;
return goog.string.trimRight(G__41210);
});
/**
...
var G__41213 = s;
return goog.string.isEmptySafe(G__41213);
});
/**
...
var temp__4124__auto___41214 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);
if(cljs.core.truth_(temp__4124__auto___41214)){
var replacement_41215 = temp__4124__auto___41214;
buffer.append([cljs.core.str(replacement_41215)].join(''));
} else {
buffer.append(ch);
}

var G__41216 = (index + (1));
index = G__41216;
continue;
}
break;
